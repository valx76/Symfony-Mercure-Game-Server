Feature: Test the MovePlayer feature
  ...
  Scenario: Move a player outside of the level
    ...
    And An exception of type "App\SharedContext\Domain\Exception\VectorOutOfAreaException" should be thrown
  ...
  Scenario: Move a player to a blocking position
    ...
    Then I should have a 500 response status code
    And An exception of type "App\Game\Domain\Exception\PositionCollidingException" should be thrown
